import type { CommunityGroup, DocumentLink, FaqItem, GalleryImage, NewsPost, Room, SiteSettings, Video } from "./types";
...
export const news: NewsPost[] = [
	{
		...
		date: "2026-06-21",
		body: ["The AGM for the Village Hall is being held in the Brian Poultney Hall starting at 7.15 on Monday 29th June 2026."],
	},
	{
		title: "Village Hall AGM",
		...
		body: ["The village hall AGM is being held on Monday 16th June 2025 in the Brian Poultney hall commencing at 7.15pm."],
	},
	{
...
<li>Contact Stuart Wilson (booking secretary) on <a href="tel:+441245364193">01245 364193</a>. A hire agreement form will be emailed or posted with a copy of the conditions of hire.</li>
	...
	},
	{
		...
		answerHtml: "<p>Any organisation may hire the hall subject to availability. Please follow the normal booking process.</p>",
	},
	{
	...
	},
	{
		...
		answerHtml: "<p>There is no requirement for hirers to live in the village of Great &amp; Little Leighs.</p>",
	},
	{
...
export const groups: CommunityGroup[] = [
	...
	{
		name: "Scouts",
		times: "Mon (except 1st of month) 6.45–8.45pm",
		contact: "Ann Quartermain",
		telephone: "Ann.Quartermain@greatnotleyscouts.org",
	},
